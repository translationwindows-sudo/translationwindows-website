...
const grid: TopicCard[] = [
  ...
  { id: "collaboration", icon: "💬", title: "Team Collaboration", desc: "Message your Project Coordinator directly, without leaving your workspace." },
];

const details: TopicDetail[] = [
  { id: "workspace", title: "Client Workspace", body: "The moment you start a project, it becomes a real workspace — not a form that disappears after submission. Files, answers and status all live in one place you can return to.", points: ["Editable until your quotation is prepared", "Categorized file library", "Live project summary"] },
  { id: "ai-quote", title: "AI Quote Assistant", body: "A guided intake asks the right follow-up questions for your specific project type, then routes your documents to a Project Coordinator for review before any price is sent.", points: ["Sequential, guided questions — not a generic form", "Upload requested only once we know what's needed", "Every quote is human-approved before it reaches you"] },
  ...
  { id: "notifications", title: "Notifications", body: "You'll hear from us the moment something changes — a quote is ready, a file was received, or your Project Coordinator has a question — without needing to check back manually.", points: ["Email confirmation on submission", "Status-change alerts", "Direct messages from your Project Coordinator"] },
  { id: "collaboration", title: "Team Collaboration", body: "Every project has a named Project Coordinator who already knows your history, your formats and your preferences — reachable directly from your workspace.", points: ["One point of contact per project", "WhatsApp, email and phone, your choice", "Context carries across every future project"] },
];
