...
const grid: TopicCard[] = [
  { id: "certified", icon: "🖋️", title: "Certified Translation", desc: "Prepared for USCIS immigration applications, with a signed Certificate of Accuracy." },
...
const details: TopicDetail[] = [
  ...
  { id: "uscis", title: "USCIS Translation", body: "Immigration paperwork has to be right the first time. We prepare every certificate to meet USCIS and consular requirements, with a signed Certificate of Accuracy included.", points: ["Birth and marriage certificates", "Police clearance letters", "Academic credentials", "Typical turnaround: 1–2 business days"] },
