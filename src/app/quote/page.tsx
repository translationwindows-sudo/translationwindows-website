...
export const metadata: Metadata = {
  ...
  description: "How our AI-assisted quotation workflow works: a guided intake, document analysis, and a human Project Coordinator who approves every price.",
};
...
const steps = [
  ...
  { n: "4", h: "A Project Coordinator approves", p: "Every price is reviewed by a person before it reaches you." },
  { n: "5", h: "You receive your quotation", p: "Most requests are reviewed within 30–60 minutes during business hours." },
];

const faqs = [
  { q: "Is the price set by AI?", a: "No. The AI drafts an estimate from your documents and answers, but a human Project Coordinator reviews and approves every quote before it is sent — technology prepares, people decide." },
  { q: "How long does it take?", a: "Most quotation requests are reviewed within 30–60 minutes during business hours. Larger or more complex projects may require additional review time so we can prepare an accurate quotation." },
    ...
    <div className="pw" id="top">
      <Container>
        ...
        <PwHero eyebrow="Platform · AI Quote Assistant" title="Quotes prepared by AI. Approved by people.">
          Our AI Quote Assistant asks the right questions for your specific project, then a Project Coordinator reviews your documents and approves the price — you never get a number nobody stands behind.
        </PwHero>
      </Container>
      <Container>
        ...
        <div className="pw-section">
          ...
          <p className="sub">
            ...
            prepares is reviewed and approved by a Project Coordinator before you ever see it — the speed of
        ...
        <CtaBand title="Ready to start?" body="Tell us what you need and your Project Coordinator will prepare an accurate quotation." />
      </Container>
    </div>
  );
}
